...
# ann_file_train = '/mnt/lustre/data/ski/train_val.pkl'
ann_file_train = '/mnt/lustre/data/ski/train.pkl'
ann_file_val = '/mnt/lustre/data/ski/val.pkl'
# ann_file_val = '/mnt/lustre/data/ski/test.pkl'
train_pipeline = [
